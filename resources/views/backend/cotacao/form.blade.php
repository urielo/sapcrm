        ...
        <div class="col-md-12 col-xs-12">
                                ...
                                <div class="panel-body" >
                                        ...
                                        <div class="row" id="rowtipoveiculo">
                                            ...
                                            @foreach($tipos::all() as $tipo)
                                                ...
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="radi radio-success">
                                                        <label>
                                                            <input type="radio"  class="radi radio-success" name="tipoveiculo" id="tipoveiculo"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-xs-8">
                                            <div class="form-group form-group-sm">
                                                <label for="veiculo" class="label label-default">Codigo Fipe - Veiculo</label>
                                        ...
                                        <div class="col-md-4 col-xs-4 " id="divano">
                                            <div class="form-group form-group-sm">
                                                <label for="anom" class="label label-default">Ano Modelo - Combustivel - Valor</label>
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-xs-4 ">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="munplaca">Município </label>
                                                        <input class="form-control form-control-sm" type="text"
                            ...
                            <div class="row" id="dadospessoafisca">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="row" id="fisica1">
                                        ...
                                        <div class="col-md-2 col-xs-2">
                                            <div class="form-group form-group-sm">
                                                <label class="label label-default" for="segdatanasc">Data Nascimento</label>
                                    ...
                                    <div class="row" id="juridica1">
                                        ...
                                        <div class="col-md-2 col-xs-2">
                                            <div class="form-group form-group-sm">
                                                <label class="label label-default" for="segdatafund">Data Fundação</label>
                                                <input class="form-control form-control-sm" type="text"
                                    ...
                                    <div class="row" id="fisica2">
                                        ...
                                        <div class="col-md-2 col-xs-2">
                                            <div class="form-group form-group-sm">
                                                <label class="label label-default" for="segestadocivil">Estado Civil</label>
                                        ...
                                        <div class="col-md-2 col-xs-2">
                                            <div class="form-group form-group-sm">
                                                <label class="label label-default" for="segrgdtemissao">Data Emissão</label>
                                                <input class="form-control form-control-sm" type="text"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-4" id="ramoatividade">
                                            <div class="form-group form-group-sm">
                                                <label class="label label-default" for="segramoatividade">Ramo Atividade</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="panel panel-default " id="panelpagamento">
                                ...
                                <div class="panel-body" style="height: 150px; overflow-x: auto;">
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="row" id="propripessoafisca">
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            ...
                                            <div class="row" id="propfisica1">
                                                ...
                                                <div class="col-md-5 col-xs-5">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propnome">Nome Completo </label>
                                                        <input class="form-control form-control-sm" type="text"
                                                               name="propnome"
                                                               id="propnome"/>
                                                    </div>
                                                ...
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propdatanasc">Data Nascimento</label>
                                                        <input class="form-control form-control-sm" type="text"
                                                ...
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propestadocivil">Estado Civil</label>
                                            ...
                                            <div class="row" id="propjuridica1">
                                                ...
                                                <div class="col-md-5 col-xs-5">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="proprazao">Razão Social </label>
                                                        <input class="form-control form-control-sm" type="text"
                                                               name="proprazao"
                                                               id="nomepropurado"/>
                                                    </div>
                                                ...
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propdatafund">Data Fundação</label>
                                                        <input class="form-control form-control-sm" type="text"
                                            ...
                                            <div class="row" id="propfisica2">
                                                ...
                                                <div class="col-md-4 col-xs-4">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="proprgoe">Orgão Emissor</label>
                                                ...
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="proprgdtemissao">Data Emissão</label>
                                                        <input class="form-control form-control-sm" type="text"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propnmcel">Celular</label>
                                                        <input class="form-control form-control-sm" type="text"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-xs-3">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propendlog">Logradouro</label>
                                                ...
                                                <div class="col-md-1 col-xs-1">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propnmend">Numero</label>
                                                        <input class="form-control form-control-sm" type="text"
                                                               name="propnmend"
                                                               id="propnmend"/>
                                                    </div>
                                                ...
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propendcidade">Cidade</label>
                                                ...
                                                <div class="col-md-5 col-xs-5" id="propprofissao">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propprofissao">Profissao</label>
                                                ...
                                                <div class="col-md-5 col-xs-5" id="propramoatividade">
                                                    <div class="form-group form-group-sm">
                                                        <label class="label label-default" for="propramoatividade">Ramo Atividade</label>
                            ...
                            <div class="row" id="conddados">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-xs-2">
                                            <div class="form-group form-group-sm">
                                                <label class="label label-default" for="conddatanasc">Data Nascimento</label>
                                                <input class="form-control form-control-sm" type="text"
                                        ...
                                        <div class="col-md-2 col-xs-2">
                                            <div class="form-group form-group-sm">
                                                <label class="label label-default" for="condestadocivil">Estado Civil</label>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="form-group form-group-sm">
                                        <label class="label label-default" for="cartaonumero">Titular do Cartão</label>
                                        <input class="form-control form-control-sm" type="text"
            ...
            <div class="row produto" id="btnproposta">
                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="form-group form-group-sm" style="float: right;">
                        <label for="btnsubmit">
                            <button type="submit" class="btn btn@extends('layouts.cotacao')
...
@section('contentSeg')
    ...
    {!!Form::close()!!}
@stop-primary" style="float: right;" id="btnsubmit">Enviar
                            </button>
                        </label>
                    </div>
                </div>
