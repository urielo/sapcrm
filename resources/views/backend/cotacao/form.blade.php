                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 ">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-sm" type="veiccor" name="veiccor" id="chassi" />
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="veicultilizacao">Ultilização</label>
                                                    <select name="veicultilizacao" id="veicultilizacao" class="form-control form-control-sm" style="font-size: 12px; padding: 0;">
                        ...
                        <div class="row" id="dadospessoafisca">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row" id="fisica1">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="segnome" id="segnome" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" value="" name="segdatanasc" id="segdatanasc" />
                                        </div>
                                    </div>
                                ...
                                <div class="row" id="juridica1">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="segdatafund" id="segdatafund" />
                                        </div>
                                    </div>
                                ...
                                <div class="row" id="fisica2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="segrgoe" id="segrgoe" class="form-control form-control-sm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5" id="profissao">
                                        <div class="form-group" >
                                    ...
                                    <div class="col-md-5"  id="ramoatividade">
                                        <div class="form-group" >
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="form-group" >
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <input class="form-control form-control-sm" type="text" name="comissao" id="comissao" aria-describedby="porcentsimbol" value="{{Auth::user()->corretor->corrcomissaopadrao}}" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="radio">         
                                            ...
                                            <label >
                                                <input type="radio" name="formapagamento" id="formapagamento" value='{!!json_encode(["idforma"=>$forma->idformapgto, "maxparc" =>$forma->nummaxparc, "parcsemjuros"=>  $forma->numparcsemjuros, "juros"=>  $forma->taxamesjuros])!!}'>{{$forma->descformapgto}}
                                            </label>
                                            @endforeach
                                        ...
                                        <div id="parcelas">
                                            <label >
                                                <input type="radio" name="quantparcela" id="formapagamento" value="1">1
                                            </label>
                                        </div>
                                        <div id="dadoscartao">
                                            <div class="form-group" >
                                                <label for="cartaonumero">Nº Cartão</label>
                                                <input class="form-control form-control-sm" type="text" name="cartaonumero" id="cartaonumero" />
                                            </div>
                                            <div class="form-group">
                                                <label for="cartaobandeira">Bandeira Cartão</label>
                                                <select name="cartaobandeira" id="cartaobandeira" class="form-control form-control-sm">
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <input class="form-control form-control-sm" type="text" name="cartaovalidade" id="cartaovalidade" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
