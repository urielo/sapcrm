    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 remove-class" data-target="col-md-offset-3">
            ...
            <div class="row hide produto-pagamento">
                ...
                <div class="col-md-12  hide"  id="botton-cotacao">

                    <div class="button-group">

                        <button class="btn btn-info button-cotacao-submit" type="submit" id="salvar">Salvar e imprimir ou email</button>
                        <button class="btn btn-primary button-cotacao-submit" type="submit" id="proposta">Emitir proposta</button>
                        <button class="btn btn-danger button-cotacao-submit" type="submit" id="nova">Nova</button>
                                ...
                                @foreach($formas::all() as $forma)
                                    ...
                                    <td>
                                        <table class="table table-condensed table-striped"
                                               id="forma_id_{{$forma->idformapgto}}">
                                            <thead>
                                            <tr>
                                                <th>Qt.</th>
                                                <th>Desc</th>
