<div class="row">
    <div class="col-md-12">
        <div class="table-responsive  ">
            <table class="table table-hover table-condensed table-datatable" id="movimento-erro" style="width: 100%">
                <thead>
                <tr>
                    <th>#Certificado</th>
                    <th>Segurado</th>
                ...
                @foreach ($dados as $movimento)
                    @if(strtolower($movimento['desc_retorno'])!='sucesso' && !empty($movimento['retorno']))
                        <tr>
