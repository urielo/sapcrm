<div class="col-md-12" id="divp-{{$produto->idproduto}}-{{$preco->idprecoproduto}}">
    <div class="checkbox">
            ...
            <input type="checkbox"
                   ...
                   value='{!!json_encode(
                        [
                            ...
                            'menorparc' => $preco->vlrminprimparc,
                            'vllmi'=>$preco->lmiproduto,
                            'vlproduto' => $preco->premioliquidoproduto
                        ]
                        )!!}'
        ...
        <div>
            <a href="#detalhe-produto-{{$produto->idproduto}}-{{$preco->idprecoproduto}}" id="span-"
